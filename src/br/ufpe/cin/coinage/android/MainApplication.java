...
public class MainApplication extends Application {
	...
	public static Map<String, Integer> allSteamGames;
	...
	public void onCreate() {
		...
		try {
			allSteamGames = Util.getSteamIdMap(new JSONObject(Util.getRawResourceAsString(MainApplication.getContext(), R.raw.all_games)));
